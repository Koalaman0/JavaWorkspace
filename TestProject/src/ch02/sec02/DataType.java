...
public class DataType {
	...
	public static void main(String[] args) {
		...
		// bit가 8개가 모여 byte 단위 : 8개의 0 또는 1을 저장함
		...
		float var3 = 3e6f; //f는 float 표현의 f
		...
		System.out.println(var4); //println문의 포멧을 변경하지 않으면 소수점 이하가 길면 지수표현 사용
